function varargout = yd(varargin)
% YD MATLAB code for yd.fig
%      YD, by itself, creates a new YD or raises the existing
%      singleton*.
%
%      H = YD returns the handle to a new YD or the handle to
%      the existing singleton*.
%
%      YD('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in YD.M with the given input arguments.
%
%      YD('Property','Value',...) creates a new YD or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before yd_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to yd_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help yd

% Last Modified by GUIDE v2.5 13-Sep-2019 03:27:10

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @yd_OpeningFcn, ...
                   'gui_OutputFcn',  @yd_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before yd is made visible.
function yd_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to yd (see VARARGIN)

% Choose default command line output for yd
...
% UIWAIT makes yd wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = yd_OutputFcn(hObject, eventdata, handles) 
