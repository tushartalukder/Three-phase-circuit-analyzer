...
% DY MATLAB code for dy.fig
%      DY, by itself, creates a new DY or raises the existing
%      singleton*.
%
%      H = DY returns the handle to a new DY or the handle to
%      the existing singleton*.
%
%      DY('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DY.M with the given input arguments.
%
%      DY('Property','Value',...) creates a new DY or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before dy_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to dy_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help dy

% Last Modified by GUIDE v2.5 13-Sep-2019 03:37:42

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @dy_OpeningFcn, ...
                   'gui_OutputFcn',  @dy_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before dy is made visible.
function dy_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to dy (see VARARGIN)

% Choose default command line output for dy
...
% UIWAIT makes dy wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = dy_OutputFcn(hObject, eventdata, handles) 
