function varargout = outdd(varargin)
% OUTDD MATLAB code for outdd.fig
%      OUTDD, by itself, creates a new OUTDD or raises the existing
%      singleton*.
%
%      H = OUTDD returns the handle to a new OUTDD or the handle to
%      the existing singleton*.
%
%      OUTDD('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in OUTDD.M with the given input arguments.
%
%      OUTDD('Property','Value',...) creates a new OUTDD or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before outdd_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to outdd_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help outdd

% Last Modified by GUIDE v2.5 12-Sep-2019 16:33:22

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @outdd_OpeningFcn, ...
                   'gui_OutputFcn',  @outdd_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before outdd is made visible.
function outdd_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to outdd (see VARARGIN)

% Choose default command line output for outdd
...
% UIWAIT makes outdd wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = outdd_OutputFcn(hObject, eventdata, handles) 
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
b1 = getappdata(0,'evalue1');
b2 = getappdata(0,'evalue2');
b3 = getappdata(0,'evalue3');
a1 = getappdata(0,'evalue4');
a2 = getappdata(0,'evalue5');
a3 = getappdata(0,'evalue6');
a4 = getappdata(0,'evalue7');
a5 = getappdata(0,'evalue8');
a6 = getappdata(0,'evalue9'); 
set(handles.b1,'string',num2str(abs(b1)));
set(handles.b2,'string',num2str(abs(b2)));
set(handles.b3,'string',num2str(abs(b3)));
set(handles.a1,'string',num2str(abs(a1)));
set(handles.a2,'string',num2str(abs(a2)));
set(handles.a3,'string',num2str(abs(a3)));
set(handles.a4,'string',num2str(abs(a4)));
set(handles.a5,'string',num2str(abs(a5)));
set(handles.a6,'string',num2str(abs(a6)));
