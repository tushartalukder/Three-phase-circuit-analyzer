...
% YY MATLAB code for yy.fig
%      YY, by itself, creates a new YY or raises the existing
%      singleton*.
%
%      H = YY returns the handle to a new YY or the handle to
%      the existing singleton*.
%
%      YY('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in YY.M with the given input arguments.
%
%      YY('Property','Value',...) creates a new YY or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before yy_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to yy_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help yy

% Last Modified by GUIDE v2.5 14-Sep-2019 03:24:15

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @yy_OpeningFcn, ...
                   'gui_OutputFcn',  @yy_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before yy is made visible.
function yy_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to yy (see VARARGIN)

% Choose default command line output for yy
...
% UIWAIT makes yy wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = yy_OutputFcn(hObject, eventdata, handles) 
...
l6=str2double(get(handles.l5,'string'));
